...
const READING_ERROR_HINTS={
 ...
 goal_alignment:'回答没有遵守本轮的建议、预测、解释或比较目标，原牌局仍然保留。',
 followup_question:'追问没有聚焦成一个具体问题，原牌局仍然保留。',
 action_text_support:'行动建议本身没有得到牌面证据支持，原牌局仍然保留。',
