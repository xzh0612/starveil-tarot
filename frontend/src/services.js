 ...
 * -> {text, source:'ai', needsClarification?, clarification?, cardReadings?, synthesis?:{text, evidenceIds}, actions?, references:[{evidenceId, cardId, position, claim, evidenceExcerpt, kind, tier, source, sourceType, sourceLabel, retrievalReasons}], followUp?, uncertainty?}
 */
