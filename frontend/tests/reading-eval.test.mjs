...
test('prompt evaluation requires evidence boundaries, JSON contract and user context',()=>{
 ...
 missingMixedTextGoalCoverageRule[0]={...messages[0],content:messages[0].content.replace('mixed 模式的首轮 text 还必须分别复述每个 goalSections 目标至少一个具体概念，不能只覆盖其中一个目标；','')};
