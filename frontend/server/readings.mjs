...
export const READING_PROMPT_VERSION='nyx-prompt-v40';
...
当 activeQuestion 明确包含关系、事业或自我主题时，顶层 text 还必须直接回应每个明确主题，并为每个主题复述至少一个主题词；开放或只有选择词的问题没有明确主题时不要强行添加主题。
