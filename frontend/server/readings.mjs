...
export const READING_PROMPT_VERSION='nyx-prompt-v46';
...
function repairGuidance({code,evidence=[],cards=[],requiredGoalEvidence=[],missingGoalCoverage=[]}={}){
 ...
 const focus=code==='missing_position_evidence'
  ...
  :code==='professional_action_boundary'
   ?'高风险行动错误：涉及买入、卖出、下单、投资、签约、起诉、停药、用药、手术、转账或借贷时，action.text 必须先安排核实现实资料、评估风险或咨询合格专业人士；不要直接要求执行不可逆决定。'
