...
export const READING_PROMPT_VERSION='nyx-prompt-v33';
...
当 activeQuestion 明确包含关系、事业或自我主题时，顶层 text 还必须直接回应该主题并复述至少一个主题词；开放或只有选择词的问题没有明确主题时不要强行添加主题。
...
function repairGuidance({code,evidence=[],cards=[],requiredGoalEvidence=[]}={}){
 ...
 const cardLines=(Array.isArray(cards)?cards:[]).map(card=>{
  ...
  :code==='question_relevance'
   ?'问题相关性错误：activeQuestion 已明确关系、事业或自我主题时，顶层 text 必须直接回应该主题并复述至少一个主题词；不要只写脱离问题的泛化牌面话。'
