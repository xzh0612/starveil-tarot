...
export const READING_KNOWLEDGE_VERSION='rws-1909-rag-v23';
...
const THEMES=[
 ...
 {name:'career',words:['工作','事业','职业','学习','备考','复习','考研','考试','创业','项目','领导','同事','收入','财务','转行','跳槽','辞职','换岗','职场','就业','求职','面试','绩效','薪资','薪水','待遇','升职','技能','论文','升学','offer','岗位','职位','公司','入职']},
...
const GOALS=[
 ...
 {name:'explanation',words:['为什么','原因','真相','核心问题是什么','问题是什么','核心是什么','启示','警示','提醒我什么','提示我什么','提醒什么','提示什么','这张牌想告诉我什么','告诉我什么','在想什么','心里怎么想','解释','解读','想了解','了解这张牌','是什么意思','什么意思','是什么含义','是什么想法','是什么关系','说明什么','说明了什么','阻碍位','放在阻碍位','哪里做错了','错在哪里','做错了什么','含义','意义','代表','意味着','怎么看','怎么理解','如何看','如何理解','怎么解释','如何解释','怎么想','如何想','对方怎么想','会怎么想','理解']},
 ...
 {name:'comparison',words:['比较','区别','哪个','哪一个','选择哪一个','哪一个更好','哪一个更适合我','哪条','哪种','选哪','选什么','该选什么','利弊','优缺点','取舍','要不要','想不想','是否想','是否需要','是不是需要','适不适合','先联系','还是等','先做哪一个','留在这里还是离开','留下还是离开','留下还是继续','还是离开','换不换工作','应该留下吗','该不该','是不是应该','是否应该','是不是要','是否要','值得继续吗','值得吗','适合我吗','适合吗','是否值得','值不值得']},
];
