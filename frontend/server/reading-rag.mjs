...
const GOALS=[
 ...
 {name:'explanation',words:['为什么','原因','真相','核心问题是什么','问题是什么','核心是什么','启示','警示','提醒我什么','提示我什么','提醒什么','提示什么','这张牌想告诉我什么','告诉我什么','在想什么','心里怎么想','心里在想什么','解释','解读','想了解','了解这张牌','是什么意思','什么意思','是什么含义','是什么想法','是什么关系','真实想法','真实的想法','内心想法','真实态度','态度是什么','是什么态度','什么态度','真实感受','想法是什么','他怎么想','她怎么想','说明什么','说明了什么','阻碍位','放在阻碍位','哪里做错了','错在哪里','做错了什么','含义','意义','代表','意味着','怎么看','怎么理解','如何看','如何理解','怎么解释','如何解释','怎么想','如何想','对方怎么想','会怎么想','理解']},
