...
Prompt v40 在 v39 的开场约束之外，新增高风险行动边界：涉及买入、卖出、下单、投资、签约、起诉、停药、用药、手术、转账或借贷时，action 必须先安排核实现实资料、评估风险或咨询合格专业人士，不能直接要求执行不可逆决定。
