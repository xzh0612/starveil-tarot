...
RAG v52 在 v49 的通用解释证据隔离、个人记忆短词保护、口语比较、因果路由和 perspective boundary 之外，补齐了胸口疼、头疼、停药、换药、起诉、买房、睡眠不足等口语高风险表达的现实边界；普通“焦虑/辞职”仍不会被自动扩大为专业风险；同时把“他到底在想什么”“对方是什么心态”“她什么意思”等第三人称内心状态口语统一纳入 perspective boundary，要求把核验落到沟通和可观察行为；v52 将个人记忆召回方法名抽成共享契约常量，让 Prompt 与实际检索器不会再次漂移。
